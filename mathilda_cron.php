...
$twitter_api_data_dirname="mathilda-twitterapidata";
$twitter_api_data_dirwithpath = $upload_dir['basedir'].'/'.$twitter_api_data_dirname;
...
while ($i < $fetches) {
	...
	if($string["errors"][0]["message"] != "") {echo "<h2>Sorry, there was a problem.</h2><p>Twitter returned the following error message:</p><p><em>".$string[errors][0]["message"]."</em></p>";return;}
