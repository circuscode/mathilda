...
function mathilda_options_userinterface_display()
{
	...
	add_settings_field("mathilda_tweet_backlink", "Backlink to Tweet Source?", "mathilda_options_display_tweet_backlink", "mathilda-options", "userinterface_settings_section");
